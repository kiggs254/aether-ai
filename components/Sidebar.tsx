...
import { LayoutDashboard, Bot, MessageSquare, Code, Settings, Zap, Plus, Layers, Inbox as InboxIcon } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="w-20 lg:w-64 flex-shrink-0 flex flex-col glass-panel h-screen sticky top-0 border-r border-white/10 z-20 transition-all duration-300">
      {/* Brand Header */}
